...
pub extern fn do_test() {
    unsafe {
        ...
        WRITE.unwrap()(CALLER_INPUTS, &arg1.field0 as *const _ as *const _, core::mem::size_of_val(&arg1.field0) as u32);
        WRITE.unwrap()(CALLER_INPUTS, &arg1.field1 as *const _ as *const _, core::mem::size_of_val(&arg1.field1) as u32);
        FINISHED_VAL.unwrap()(CALLER_INPUTS);

        let arg2 = MyStruct { field0: 0xbe10_2623_e810_ad39, field1: None };
        WRITE.unwrap()(CALLER_INPUTS, &arg2.field0 as *const _ as *const _, core::mem::size_of_val(&arg2.field0) as u32);
        WRITE.unwrap()(CALLER_INPUTS, &arg2.field1 as *const _ as *const _, core::mem::size_of_val(&arg2.field1) as u32);
        FINISHED_VAL.unwrap()(CALLER_INPUTS);

        let output = i_am_opaque_to_the_test_harness(arg0, &arg1, arg2);

        WRITE.unwrap()(CALLER_OUTPUTS, &output as *const _ as *const _, core::mem::size_of_val(&output) as u32);
